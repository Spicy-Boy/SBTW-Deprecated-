...
public class BiomeDecorator
{
    ...
    //AARON ADDED! Branch generation variables...
    protected WorldGenerator branchGen;
    protected int branchesPerChunk;
    
    //AARON ADDED! Initializes branches VVV
    ...
    public BiomeDecorator(BiomeGenBase par1BiomeGenBase)
    {
        ...
        //AARON ADDED: Initialized boooy
        this.branchGen = new WorldGenBranches(SuperBTWDefinitions.branchBlock.blockID);
    ...
    protected void decorate()
    {
        ...
        for (var2 = 0; var2 < this.branchesPerChunk; ++var2)
        {
            var3 = this.chunk_X + this.randomGenerator.nextInt(16) + 8;
            var4 = this.randomGenerator.nextInt(128);
            var7 = this.chunk_Z + this.randomGenerator.nextInt(16) + 8;
